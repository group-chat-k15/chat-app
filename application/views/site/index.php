...
<head>
	...
	<link rel="stylesheet" type="text/css" href="<?=base_url('public/')?>css/dropzone.min.css">
	<link rel="stylesheet" type="text/css" href="<?=base_url('public/')?>css/style.css">
</head>
<body id="<?= $_SESSION['id'] ? $_SESSION['id'] : 0 ?>">
	...
	<script type="text/javascript" src="<?=base_url('public/')?>js/dropzone.js"></script>
